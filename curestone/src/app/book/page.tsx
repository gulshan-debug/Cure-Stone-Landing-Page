          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border border-border/50 rounded-3xl overflow-hidden shadow-sm">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-bold text-sm text-slate-900 leading-tight">CureStone Kidney Clinic</p>
              ...
              <div className="bg-primary/5 border border-primary/10 p-8 rounded-3xl space-y-4">
                <p className="text-[10px] font-black uppercase tracking-widest text-primary">Why CureStone</p>
